...
function handleDrag(event) {
  ...
  let index = Math.floor(x / 300);

  // Actualizar el índice actual
  currentIndex = index;

  // Actualizar la imagen actual {{file_url('public://images/producto8.png') }}"
  document.querySelector(".fotos img").src = `{{ file_url('public://images/(${currentIndex + 1}.png) }}`;
}

document.querySelector(".fotos").addEventListener("mousedown", handleDrag);
document.querySelector(".fotos").addEventListener("mousemove", handleDrag);
;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
