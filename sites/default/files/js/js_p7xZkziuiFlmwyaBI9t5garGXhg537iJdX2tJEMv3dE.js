...
const handleOnMovee = (e) => {
  ...
  for (const image of container.getElementsByClassName
  ("image-content")){
    image.animate(
      {
        objectPosition: `${nextPercentage}%
        center`,
      },
      { duration: 1200, fill: "forwards"}
    )
...
window.onmousemove = (e) => handleOnMovee(e)
window.ontouchmove = (e) => handleOnMovee(e.touches[0]);
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
