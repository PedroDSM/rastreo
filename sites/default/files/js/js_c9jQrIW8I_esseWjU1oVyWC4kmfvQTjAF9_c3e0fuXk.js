...
function handleDrag(event) {
  ...
  document.querySelector(".fotos img").src = `{{ file_url('public://images/producto${currentIndex + 1}.png') }}`;

  // Actualizar la posición del contenedor de fotos
  let fotos = document.querySelector(".fotos");
  fotos.scrollLeft = index * 300;
